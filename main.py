...
from td_mmg.configs.default_config import add_arguments_by_config_class, combine_args_into_config
from td_mmg.configs.mm_mgdcf_default_config import MMMGDCFConfig
from td_mmg.configs.masked_mm_mgdcf_default_config import load_masked_mm_mgdcf_default_config 
import sys
import argparse
import time
import torch.nn.functional as F

from td_mmg.layers.mirf_gt import TDMMG
from td_mmg.vector_search.vector_search import VectorSearchEngine
...
from td_mmg.layers.mm_mgdcf import MMMGDCF
import shortuuid
from td_mmg.layers.sign import random_project, sign_pre_compute
from td_mmg.losses import compute_info_bpr_loss, compute_l2_loss
from td_mmg.utils.data_loader_utils import create_tensors_dataloader
from td_mmg.evaluation.ranking import evaluate_mean_global_metrics
from td_mmg.layers.mgdcf import MGDCF
from td_mmg.load_data import load_data
import torch
import numpy as np
import dgl
...
train_user_item_edges, valid_user_item_edges, test_user_item_edges, train_user_items_dict, train_mask_user_items_dict, valid_user_items_dict, valid_mask_user_items_dict, test_user_items_dict, test_mask_user_items_dict, num_users, num_items, v_feat, t_feat, dt_norm = load_data(args.dataset)
...
g = MGDCF.build_sorted_homo_graph(train_user_item_edges, num_users=num_users, num_items=num_items, dt_norm=dt_norm).to(device)
...
result_dict = {
    ...
    'early_stop_valid_results_dict': early_stop_valid_results_dict,
    'early_stop_test_results_dict': early_stop_test_results_dict,
